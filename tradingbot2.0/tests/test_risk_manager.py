...
class TestPositionSizer:
    ...
    def test_calculate_for_1000_balance(self, position_sizer):
        ...
        # But with 75% confidence (1.0x) and $20 risk budget / $10 per contract = 2 base
        # Final contracts = min(2, 2) = 2, but we're only trading 1 with 8-tick stop
...
class TestRiskModuleIntegration:
    ...
    def test_full_trade_flow(self):
        ...
        # $1000 balance = tier 2 (max 2 contracts), 75% confidence = 1.0x
        # $1000 * 2% = $20 risk budget / $10 per contract = 2 contracts
...
class TestEdgeCases:
    ...
    def test_boundary_balance_values(self, position_sizer):
        ...
        # Exactly $1000 - should be tier 2 (2 contracts)
